...
class LoginViewModel extends BaseViewModel {
  ...
  Future<void> login(String email, String password) async {
    setBusy(true);
    final url = Uri.parse('http://smdb.sadeem-lab.com/api/v1/web-login');
...
//-------------------------------//
  ...
  Future<void> signup(
    ...
    final url = Uri.parse('http://smdb.sadeem-lab.com/api/v1/register');
    final response = await post(
      url,
      body: {
        'email': email,
  ...
  Future<void> getUser() async {
    setBusy(true);
    final url = Uri.parse('http://smdb.sadeem-lab.com/api/v1/me');
